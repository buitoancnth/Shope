				...
				<div class="col-sm-12">
					<div class="beta-products-list">
						...
						<div class="beta-products-details">
							<p class="pull-left">found {{ count($new_products) }} results</p>
							...
							@foreach( $new_products as $new_product)
								<div class="col-sm-3" style="margin-bottom: 20px;">
									<div class="single-item">
										@unless ($new_product->promotion_price == 0)
										...
										<div class="single-item-body">
											...
											<p class="single-item-price">
												@if ($new_product->promotion_price == 0)
													<span class="flash-sale">{{ number_format($new_product->unit_price) }}</span>
												@else
						...
						<div class="row" style="text-align: center;">{{ $new_products->links() }}</div>
					...
					<div class="beta-products-list">
						...
						<div class="row">
							@foreach( $top_products as $top_product )
								<div class="col-sm-3" style="margin-bottom: 20px;">
									<div class="single-item">
										@unless( $top_product->promotion_price )
											<div class="ribbon-wrapper"><div class="ribbon sale">Sale</div></div>
										@endunless
										<div class="single-item-header">
											<a href="product.html"><img src="source/image/product/{{ $top_product->image }}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
						...
						<div class="row" style="text-align: center;">{{ $top_products->links() }}</div>
