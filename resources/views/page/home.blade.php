										...
										<div class="single-item-body">
											...
											<p class="single-item-price">
												@if ($new_product->promotion_price == 0)
													<span class="flash-sale">{{$new_product->unit_price}}</span>
												@else
										...
										<div class="single-item-body">
											...
											<p class="single-item-price">
												@if($top_product->promotion_price == 0)
													<span class="flash-sale">{{ $top_product->promotion_price }}</span>
												@else
													<span class="flash-del">{{ $top_product->unit_price }}</span>
													<span class="flash-sale">{{ $top_product->promotion_price }}</span>
												@endif
											</p>
										</div>
