		...
		<div class="header-body">
			<div class="container beta-relative">
				...
				<div class="pull-right beta-components space-left ov">
					...
					<div class="beta-comp">
						<div class="cart">
							<div class="beta-select"><i class="fa fa-shopping-cart"></i> Giỏ hàng (@if(Session::has('cart')) {{Session::get('cart')->totalQty}} @else Trong @endif) <i class="fa fa-chevron-down"></i></div>
